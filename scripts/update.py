...
if __name__ == '__main__':
    ...
    with serial.Serial(args.dev, args.baud, timeout=2) as ser:
        ...
        print('sending {} byte payload:\n\tversion: {}\n\tmain_ptr_addr: {}\n\tmain_ptr: {}\n\tupdate_flag: {}\n\tflash_text_start: {}\n\tflash_text_size: {}\n\tflash_rodata_start: {}\n\tflash_rodata_size: {}\n\tapp_text: {} bytes\n\tapp_rodata: {} bytes\n'.format(len(header) + len(app_text) + len(app_rodata), VERSION, hex(main_ptr_addr), hex(appflash_text_start | 0x1), hex(update_flag_addr), hex(appflash_text_start), hex(appflash_text_size), hex(appflash_rodata_start), hex(appflash_rodata_size), len(app_text), len(app_rodata)))
